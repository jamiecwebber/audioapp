...
class TestUserService(BaseTestCase):
	...
	def test_main_no_users(self):
		"""Ensure that the main route behaves correctly when no users have been added to the database."""
	...
	def test_main_with_users(self):
		"""Ensure that the main route behaves correctly when users have been added to the database."""
		add_user("michael", "michael@mherman.org")
		add_user("fletcher", "fletcher@notreal.com")
		with self.client:
			response = self.client.get('/')
